...
const SkillSection = () => {
  return (
    <div className='container mx-auto px-10 mt-20'>
      <h1 className='font-bold font-body  text-4xl text-center mb-10'>
        Our Services
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="relative border border-gray-300 pr-4 mb-6 md:mb-0 group overflow-hidden rounded-xl transition duration-300 ease-in-out transform hover:scale-110 hover:border-blue-500 hover:shadow-lg">
          <div className="p-4">
            ...
            <button className="text-white bg-blue-500 rounded-xl px-4 py-2 hover:bg-blue-600 transition duration-300 ease-in-out">
        ...
        {/* Column 2 */}
        <div className="relative border border-gray-300 pr-4 mb-6 md:mb-0 group overflow-hidden rounded-xl transition duration-300 ease-in-out transform md:hover:scale-105 hover:border-blue-500 hover:shadow-lg">
          <div className="p-4">
            <h3 className="text-blue-500">
              Graphics
            </h3>
